...
* make the box accessable by the host at IP `192.168.33.22` or localhost:8080

* sync the current folder with `/vagrant` inside the box
...
* create a folder inside /vagrant

* install apache 2.4, php 5.6, MySQL,Ioncube , git and Composer

* also setting a pre-chosen password for MySQL
